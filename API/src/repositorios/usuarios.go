...
// Buscar traz todos os usuarios que atendem um nome ou nick
...
// Atualizar informacoes de um usuario no banco de dados
func (repositorio Usuarios) Atualizar(ID uint, usuario modelos.Usuario) error {
	statement, erro := repositorio.db.Prepare(
...
// BUSCAR USUARIOS QUE UM DETERMINADO USUARIO ESTA SEGUINDO
...
// TRAZ A SENHA DE UM USUARIO POR ID
