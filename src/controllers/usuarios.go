...
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("nao e possivel passar um usuario que nao seja o seu"))
		return
	}
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	if erro = repositorio.Atualizar(uint(usuarioID), usuario); erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
// SeguirUsuario permite que um usuario siga o outro
...
func PararSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	repositorio := repositorios.NovoRepositorioDeUsuarios(db)
	if erro = repositorio.PararSeguirUsuario(usuarioID, seguidorID); erro != nil {
		respostas.Erro(w, http.StatusInternalServerError, erro)
		return
	}
...
// Permite atualizar a senha de um usuario
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	if usuarioID != usuarioIDNoToken {
		respostas.Erro(w, http.StatusForbidden, errors.New("nao e possivel atualizar a senha deum usuario que nao seja o seu"))
		return
	}
